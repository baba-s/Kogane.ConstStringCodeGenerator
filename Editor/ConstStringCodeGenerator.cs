...
namespace Kogane
{
    ...
    public static class ConstStringCodeGenerator
    {
        ...
        /// </summary>
        public static string Generate( in ConstStringCodeGeneratorOptions options )
        {
        ...
        /// </summary>
        private static string GetValuesText( in ConstStringCodeGeneratorOptions options )
        {
        ...
        /// </summary>
        private static string GetGetValuesContents( in ConstStringCodeGeneratorOptions options )
        {
            var builder = new StringBuilder();
